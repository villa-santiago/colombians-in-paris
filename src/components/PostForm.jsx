      ...
      <div>
        <label className="block font-medium mb-1">
          ...
          >
            ...
            <option value="Paris 4 - Hôtel-de-Ville">
            ...
            <option value="Paris 7 - Palais-Bourbon">
            ...
            <option value="Paris 17 - Batignolles-Monceaux">
              Paris 17 - Batignolles-Monceaux{" "}
            </option>
            <option value="Paris 18 - Buttes-Montmartre">
              Paris 18 - Buttes-Montmartre{" "}
            </option>
            <option value="Paris 19 - Buttes-Chaumont">
              Paris 19 - Buttes-Chaumont{" "}
            </option>
            <option value="Paris 20 - Ménilmontant">
